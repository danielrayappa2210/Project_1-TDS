...
def data_generation():
    try:
        if os.name == 'nt':  # Check if the OS is Windows
            subprocess.run(["cmd", "python https://raw.githubusercontent.com/sanand0/tools-in-data-science-public/tds-2025-01/project-1/datagen.py daniel.putta@gramener.com"])
        else:
            subprocess.run(["python", "https://raw.githubusercontent.com/sanand0/tools-in-data-science-public/tds-2025-01/project-1/datagen.py", "daniel.putta@gramener.com"])
        return True
    except:
        return False
